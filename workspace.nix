    ...
    yazi = {
      ...
      keymap = {
        mgr.keymap = [
          ...
          {
            on = "i";
            run = "shell dua interactive";
            desc = "Open file size manager";
          }
          {
            on = "y";
            run = "yank";
          ...
          }
          {
            ...
            run = "cd /run/media/mlys/";
            desc = "Open removable media";
          }
          {
            on = [
              "g"
          ...
          }
          {
            ...
            run = "cd ~/Obsidian/Books";
            desc = "Open the library";
          }
          {
            on = [
              "g"
            ...
            run = "cd ~/.local/share/PrismLauncher";
            desc = "Open the minecraft instances location";
          }
          # Tabs
          {
            on = "t";
